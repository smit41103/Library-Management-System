    ...
    return (
        <div className='footer'>
            <div>
                <div className='footer-data'>
                    <div className="contact-details">
                        <h1>Contact Us</h1>
                        <p>Odoo library</p>
                        <p>Gandhinagar-382443</p>
                        <p>Gujarat</p>
                        <p>India</p>
                        <p><b>Email:</b>odoolibrary@gmail.com</p>
                    </div>
            ...
            <div className='copyright-details'>
                <p className='footer-copyright'> <br /><span>Designed with ❤️ by Cybernauts</span></p>
            </div>
        </div>
    )
}
